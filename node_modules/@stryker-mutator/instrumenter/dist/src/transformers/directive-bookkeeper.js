...
exports.DirectiveBookkeeper = void 0;
...
class DirectiveBookkeeper {
    ...
    processStrykerDirectives({ loc, leadingComments }) {
        leadingComments === null || leadingComments === void 0 ? void 0 : leadingComments.map((comment) => this.strykerCommentDirectiveRegex.exec(comment.value)).filter(util_1.notEmpty).forEach(([, directiveType, scope, mutators, optionalReason]) => {
...
exports.DirectiveBookkeeper = DirectiveBookkeeper;
