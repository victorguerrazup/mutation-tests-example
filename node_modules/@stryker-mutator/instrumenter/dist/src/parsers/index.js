...
function createParser(parserOptions) {
    const jsParse = (0, js_parser_1.createParser)(parserOptions);
    return function parse(code, fileName, formatOverride) {
        ...
        switch (format) {
            ...
            case syntax_1.AstFormat.Tsx:
                return (0, ts_parser_1.parseTsx)(code, fileName);
            case syntax_1.AstFormat.TS:
                return (0, ts_parser_1.parseTS)(code, fileName);
            case syntax_1.AstFormat.Html:
                return (0, html_parser_1.parse)(code, fileName, { parse });
        }
    };
}
