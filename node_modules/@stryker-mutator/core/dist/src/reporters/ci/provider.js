...
function determineCIProvider() {
    ...
    if ((0, object_utils_1.getEnvironmentVariable)('HAS_JOSH_K_SEAL_OF_APPROVAL')) {
        return new travis_provider_1.TravisProvider();
    }
    else if ((0, object_utils_1.getEnvironmentVariable)('CIRCLECI')) {
        return new circle_provider_1.CircleProvider();
    }
    else if ((0, object_utils_1.getEnvironmentVariable)('GITHUB_ACTION')) {
