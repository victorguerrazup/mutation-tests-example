...
class EventRecorderReporter {
    constructor(log, options) {
        ...
        this.allWork = [];
        this.index = 0;
        this.createBaseFolderTask = (0, file_utils_1.cleanFolder)(this.options.eventReporter.baseDir);
    }
...
EventRecorderReporter.inject = (0, plugin_1.tokens)(plugin_1.commonTokens.logger, plugin_1.commonTokens.options);
