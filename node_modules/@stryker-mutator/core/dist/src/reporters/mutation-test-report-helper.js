...
class MutationTestReportHelper {
    ...
    reportAll(results) {
        ...
        const metrics = (0, mutation_testing_metrics_1.calculateMutationTestMetrics)(report);
    ...
    determineExitCode(metrics) {
        ...
        if (typeof breaking === 'number') {
            if (mutationScore < breaking) {
                ...
                (0, object_utils_1.setExitCode)(1);
            }
            else {
    ...
    toFileResult(fileName) {
        ...
        if (sourceFile) {
            ...
            this.log.warn((0, util_1.normalizeWhitespaces)(`File "${fileName}" not found
    ...
    toTestFile(fileName) {
        ...
        if (fileName) {
            ...
            if (sourceFile) {
                ...
                this.log.warn((0, util_1.normalizeWhitespaces)(`Test file "${fileName}" not found
    ...
    discoverDependencies() {
        const discover = (specifier) => {
            try {
                return [specifier, (0, util_1.requireResolve)(`${specifier}/package.json`).version];
            }
            catch {
...
MutationTestReportHelper.inject = (0, plugin_1.tokens)(di_1.coreTokens.reporter, plugin_1.commonTokens.options, di_1.coreTokens.inputFiles, plugin_1.commonTokens.logger, di_1.coreTokens.dryRunResult);
