...
class DashboardReporterClient {
    ...
    async updateReport({ report, projectName, version, moduleName, }) {
        ...
        const apiKey = (0, object_utils_1.getEnvironmentVariable)(STRYKER_DASHBOARD_API_KEY);
        if (apiKey) {
        ...
        if ((0, net_utils_1.isOK)(result.message.statusCode || 0)) {
...
DashboardReporterClient.inject = (0, plugin_1.tokens)(plugin_1.commonTokens.logger, tokens_1.dashboardReporterTokens.httpClient, plugin_1.commonTokens.options);
