...
class CommandTestRunner {
    ...
    async mutantRun({ activeMutant }) {
        ...
        return (0, test_runner_1.toMutantRunResult)(result);
    }
    run({ activeMutantId }) {
        return new Promise((res, rej) => {
            ...
            const childProcess = (0, child_process_1.exec)(this.settings.command, { cwd: this.workingDir, env });
            childProcess.on('error', (error) => {
                (0, object_utils_1.kill)(childProcess.pid)
            ...
            this.timeoutHandler = async () => {
                ...
                await (0, object_utils_1.kill)(childProcess.pid);
            };
            ...
            function errorResult(error) {
                return {
                    errorMessage: (0, util_1.errorToString)(error),
