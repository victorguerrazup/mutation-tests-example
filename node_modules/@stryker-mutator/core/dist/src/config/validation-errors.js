...
const lodash_groupby_1 = (0, tslib_1.__importDefault)(require("lodash.groupby"));
/**
...
function mergeTypeErrorsByPath(typeErrors) {
    const typeErrorsByPath = (0, lodash_groupby_1.default)(typeErrors, (error) => error.instancePath);
