...
class TemporaryDirectory {
    ...
    createRandomDirectory(prefix) {
        ...
        const dir = path_1.default.resolve(this.temporaryDirectory, `${prefix}${(0, object_utils_1.random)()}`);
    ...
    copyFile(fromFilename, toFilename, instrumenter) {
        return new Promise((resolve, reject) => {
            let readStream = (0, fs_1.createReadStream)(fromFilename, { encoding: 'utf8' });
    ...
    async dispose() {
        ...
        if (this.removeDuringDisposal) {
            ...
            try {
                await (0, file_utils_1.deleteDir)(this.temporaryDirectory);
            }
            catch (e) {
...
TemporaryDirectory.inject = (0, plugin_1.tokens)(plugin_1.commonTokens.logger, plugin_1.commonTokens.options);
