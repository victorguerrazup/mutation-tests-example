...
class NpmClient {
    ...
    search(path) {
        ...
        return this.searchClient
            ...
            .then(handleResult(path))
            .catch((err) => {
            this.log.error(`Unable to reach npms.io (for query ${path}). Please check your internet connection.`, (0, util_1.errorToString)(err));
            const result = {
                results: [],
                total: 0,
            };
...
NpmClient.inject = (0, plugin_1.tokens)(plugin_1.commonTokens.logger, _1.initializerTokens.restClientNpmSearch, _1.initializerTokens.restClientNpm);
