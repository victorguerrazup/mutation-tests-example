...
class ConcurrencyTokenProvider {
    constructor(options, log) {
        ...
        if (options.checkers.length > 0) {
            ...
            this.checkerToken$ = (0, rxjs_1.range)(this.concurrencyCheckers);
            ...
            this.checkerToken$ = (0, rxjs_1.range)(1); // at least one checker, the `CheckerFacade` will not create worker process.
...
ConcurrencyTokenProvider.inject = (0, typed_inject_1.tokens)(plugin_1.commonTokens.options, plugin_1.commonTokens.logger);
