...
class LogConfigurator {
    static createMainProcessAppenders(consoleLogLevel, fileLogLevel, allowConsoleColors) {
        ...
        const multiAppender = { type: require.resolve('./multi-appender'), appenders: ["filterLevelConsole" /* FilterLevelConsole */] };
        ...
        let allAppenders = {
            ...
            ["filterLog4jsCategoryConsole" /* FilterLog4jsCategoryConsole */]: { type: 'categoryFilter', appender: "console" /* Console */, exclude: 'log4js' },
            ["filterLevelConsole" /* FilterLevelConsole */]: { type: 'logLevelFilter', appender: "filterLog4jsCategoryConsole" /* FilterLog4jsCategoryConsole */, level: consoleLogLevel },
        ...
        if (fileLogLevel.toUpperCase() !== "off" /* Off */.toUpperCase()) {
            ...
            const filterLog4sCategory = { type: 'categoryFilter', appender: "file" /* File */, exclude: 'log4js' };
            const filterFileAppender = {
                type: 'logLevelFilter',
                appender: "filterLog4jsCategoryFile" /* FilterLog4jsCategoryFile */,
                level: fileLogLevel,
            };
            ...
            allAppenders = {
                ...allAppenders,
                ["file" /* File */]: fileAppender,
                ["filterLog4jsCategoryFile" /* FilterLog4jsCategoryFile */]: filterLog4sCategory,
                ["filterLevelFile" /* FilterLevelFile */]: filterFileAppender,
            };
            multiAppender.appenders.push("filterLevelFile" /* FilterLevelFile */);
        }
        return allAppenders;
    }
